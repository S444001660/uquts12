...
class ValidationUtils {
  ...
  static String? validateSerialNumber(String? value) {
    ...
    // التحقق من أن الرقم التسلسلي يتكون من 1 إلى 10 حروف/أرقام إنجليزية فقط
    final serialNumberRegex = RegExp(r'^[a-zA-Z0-9]{1,10}$');
    if (!serialNumberRegex.hasMatch(value.trim())) {
      return 'الرقم التسلسلي يجب أن يتكون من 1 إلى 10 حرفًا/رقمًا إنجليزيًا فقط';
    }
